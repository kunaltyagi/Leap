...
lib_dir = os.path.abspath(os.path.join(src_dir, './library'))
print(lib_dir)
...
#class ClearSpaceGesture(Gesture):
#	clear_space_detected = False
#
#	def __init__(self):
#		j
#	
...
#
##	controller = controller.add_listener(listener)
#
